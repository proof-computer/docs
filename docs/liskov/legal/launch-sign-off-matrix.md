...
| **BLOCKER** | B2B-only journey | Business-purpose checkbox, organisation/country field, under-18 exclusion, business-oriented marketing; consumer use response | Product/Legal | **In progress — live audit found Company Name and general Terms only, with no business-country, approved business-purpose/18+ statement, server evidence, explicit business-only marketing line or consumer response. B2B packet 7cy8 waits on Product/Legal question szc3 and proceeds independently of the Stripe canary** |
