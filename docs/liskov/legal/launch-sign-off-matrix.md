...
| **BLOCKER** | Website/e-commerce disclosures | Footer, contact page, checkout and invoices show required identity/address/email/VAT/price information | Legal/Product | **In progress — owner approved GB311456142, hello@proof.computer and price copy on 4 September 2026; site PRs #35–#36; live Stripe Checkout/invoice evidence pending** |
