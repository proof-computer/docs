...
challenge endpoints Baran checks.

## What You Can Do

- Launch the bundled Baran Express demo and get a public proof page.
- Deploy a supported Node.js webserver project from `baran.json`.
- Use job-owned TLS for canonical Baran hostnames.
...
Baran currently supports long-running Node.js webserver jobs on
...
Baran does not yet support arbitrary hosting, arbitrary runtimes,
