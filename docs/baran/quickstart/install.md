...
Install Baran on a machine that can hold local signing material. A
Baran app repository should contain app code and project config, not
live credentials.
...
Baran contexts store environment variable names, not secret values. Keep
