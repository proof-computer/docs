...
```text
GET https://control.switchboard.proof.computer/v1/network-manifest
```
...
`switchboard.service-catalog.v1` signature domain.
...
The Switchboard Express demo polls this endpoint when these env vars are
present:
